# Judgment Overlay — plume（最後查證日期：2026-07-08）
...
- （已解除，2026-07-10）`time` crate 曾釘在 0.3.47：cookie 0.18 對 time 0.3.48 編譯失敗（E0119）；0.3.48 已 yank，0.3.49+ 修復 E0119，pin 已移除（CLAUDE.md「Known pins」）。
